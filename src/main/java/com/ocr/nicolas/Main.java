...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        StarWars.afficherCaracteristiquesAffaire();
        StarWars.addProgrammesAffaire(StarWars1);
       StarWars.afficherListProgrammesAffaire();
 ...
 TerminatorDeux.addProgrammesAffaire(TermintorDeux1);
  ...
  TerminatorDeux.afficherListProgrammesAffaire();
   ...
   extractionDescriptionAffaire.ecrireFichier("Salut");
